"""``jetson-arena overview`` — read-only descriptive snapshot of the agent.
...
:mod:`jetson_arena.cli._commands.cli`).
...
from jetson_arena.cli._commands.whoami import report

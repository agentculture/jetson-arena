...
Every failure inside jetson-arena raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`jetson_arena.cli._output`,
...
# Exit-code policy. Documented in ``jetson-arena learn`` output.
# 0      = success

...
from jetson_arena import __version__
from jetson_arena.cli._errors import EXIT_USER_ERROR, CliError
from jetson_arena.cli._output import emit_error

_ISSUES_URL = "https://github.com/agentculture/jetson-arena/issues"
...
def _build_parser() -> argparse.ArgumentParser:
    from jetson_arena.cli._commands import cli as _cli_group
    from jetson_arena.cli._commands import doctor as _doctor_cmd
    from jetson_arena.cli._commands import explain as _explain_cmd
    from jetson_arena.cli._commands import learn as _learn_cmd
    from jetson_arena.cli._commands import overview as _overview_cmd
    from jetson_arena.cli._commands import whoami as _whoami_cmd

    parser = _CliArgumentParser(
        prog="jetson-arena",
        description="jetson-arena — a clonable template for AgentCulture mesh agents.",
    )
    parser.add_argument(
        "--version",
        action="version",
    ...
    #   from jetson_arena.cli._commands import my_noun as _my_noun_group

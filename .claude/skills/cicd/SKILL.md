...
type: command
description: >
  jetson-arena's CI/CD lane, layered on `devex pr`. Delegates lint / open /
  ...
  unresolved threads). Use when: creating PRs in jetson-arena, handling
